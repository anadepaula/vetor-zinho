...
array_length: 100
msg_a1_before: .asciiz "Array antes: "
msg_a1_after:  .asciiz "Array depois: "
msg_timestamp_before: .asciiz "Timestamp inicio: "
msg_timestamp_after: .asciiz "Timestamp fim: "
semicolon: .asciiz ":"
newline:       .asciiz "\n"
space:         .asciiz " "
...
print_timestamp_inicio:
    li  $v0, 4
    la $a0, msg_timestamp_before
    syscall
